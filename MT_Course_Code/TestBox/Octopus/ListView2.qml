...
Item {
    ...
    GridLayout {
        ...
        Rectangle {
            ...
            //radius: 4 * scaleFactor  // Optional: subtle rounded corners
            //border.color: "#606060"  // Optional: subtle border
            //border.width: 0.3
                ...
                ColumnLayout {
                    ...
                    GridLayout {
                        ...
                        Button {
                            ...
                            onClicked: {
                                var selection = "6";
                                var startDateTimeStr = startDateTime ? startDateTime.toISOString() : "";
                                var endDateTimeStr = endDateTime ? endDateTime.toISOString() : "";
                                var startTimestamp = startDateTime ? startDateTime.getTime() : 0;
                                var endTimestamp = endDateTime ? endDateTime.getTime() : 0;
                                ...
                                var obj = {
                                    ...
                                    StartMonth: startDateTime ? startDateTime.getMonth() + 1 : 0,
        ...
        Rectangle {
            ...
            CellBox {
                ...
                ColumnLayout {
                    ...
                    // Content Grid (your existing Cell H content goes here)
                    GridLayout {
                        Layout.fillWidth: true
                        Layout.fillHeight: true
                        columns: 3
        ...
        // Cell I - Miscellaneous (with subtle gradient)
        Rectangle {
            id: cellIContainer
            Layout.row: 2
            Layout.column: 2
            ...
            CellBox {
                ...
                ColumnLayout {
                    ...
                    // Content Grid (your existing Cell I content goes here)
                    GridLayout {
                        Layout.fillWidth: true
                        Layout.fillHeight: true
                        columns: 3
